...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for k, v in results_dic.items():
      idx3 = 0  # default not a dog
      idx4 = 0  # default not a dog
      # check pet image is a dog
      if results_dic[k][0] in dognames:
        idx3 = 1
      # check classifier is a dog
      if results_dic[k][1] in dognames:
        idx4 = 1
